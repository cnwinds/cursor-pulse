...
def test_format_china_datetime_from_utc():
    assert format_china_datetime(datetime(2026, 7, 15, 4, 30, 0, tzinfo=UTC)) == "2026-07-15 12:30:00"


def test_format_china_date_from_utc():
    assert format_china_date(datetime(2026, 7, 23, 16, 0, 0, tzinfo=UTC)) == "2026-07-24"
...
def test_format_china_datetime_iso_for_tools():
    ...
    assert format_china_datetime_iso(datetime(2026, 7, 22, 7, 15, 55, tzinfo=UTC)) == "2026-07-22T15:15:55+08:00"
...
def test_display_datetime_respects_timezone_context():
    ...
    with activate_display_timezone("America/New_York"):
        assert format_display_datetime_iso(datetime(2026, 7, 15, 12, 0, 0, tzinfo=UTC)) == "2026-07-15T08:00:00-04:00"


def test_tool_datetime_alias():
    assert tool_datetime(datetime(2026, 7, 22, 7, 15, 55, tzinfo=UTC)) == "2026-07-22T15:15:55+08:00"
