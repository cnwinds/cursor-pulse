...
def test_split_sample_by_natural_month():
    ...
    assert splits["2026-03"].summary.event_count == 1
    assert splits["2026-04"].summary.event_count == 1
    assert splits["2026-05"].summary.event_count == 1
    assert splits["2026-06"].summary.event_count == 1
