...
@pytest.fixture
def settings_client(_chat_memory_settings_app, tmp_path, monkeypatch):
    # File URL required: effective_config / chat_memory overrides reopen via DATABASE_URL.
    client, config, proxy = _chat_memory_settings_app
