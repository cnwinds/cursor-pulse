...
def infer_vendor_slug_from_text(text: str) -> str | None:
    """从自由文本（如「提交智谱的用量」）推断厂商 slug。"""
...
def vendor_display_name(vendor_slug: str) -> str:
    labels = {
        "zhipu": "智谱",
        "minimax": "MiniMax",
        "codex": "Codex",
    }
    return labels.get(vendor_slug, vendor_slug)
