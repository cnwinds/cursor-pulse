...
def channel_admin(user_id: str, config, repo: Repository, *, channel: str | None = None) -> bool:
...
def channel_member(
    ...
    *,
    ...
    return repo.get_or_create_member(user_id, display_name or user_id, channel=channel)
